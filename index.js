...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const animalNames = array.map(function (item){
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const animalsWithLowerPopulation = array.filter(function(item){
      if (item.population < 5 )
      return item.animal_name
    })
    return animalsWithLowerPopulation;
  }
  ...
  */
  ...
  function USApop(array){
    const totalPopulation = array.reduce(function(last_value,current_value){
      return last_value + current_value.population
    },0)
